        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <div id="<?php echo $id; ?>" class="st-user-condition">
                <div class="field-link-target description description-wide">
                    <label style="font-style: italic;"><?php _e( 'Who can see this menu', 'st-user' ); ?></label><br/>
                ...
                <p class="description">
                    <label>
                        ...
                        <?php _e( 'Login/Logout link. If user is logged in this item will be logout link' , 'st-user' ); ?>
                    </label>
                </p>
                ...
                <div class="more-title" style="<?php echo get_post_meta( $item_id, '_is_logout', true ) == 'yes' ? '' : ' display: none; '; ?>">
                    ...
                    <p class="description description-thin">
                        <label for="edit-menu-item-logout-title-<?php echo $item_id; ?>">
                            <?php _e( 'Logout Label', 'st-user' ); ?><br />
                ...
                <p class="description">
                    <label>
                        ...
                        <?php _e( 'Hide item when user logged in', 'st-user' ); ?>
                    </label>
                </p>
                <br style="clear: both;"/>
