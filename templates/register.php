...
<form id="st-signup" class="stuser-form st-register-form<?php echo $in_modal ? ' in-st-modal' : ''; ?>"  action="<?php echo site_url('/'); ?>" method="post">
    ...
    <div class="stuser-form-header">
        <h3><?php echo esc_html( ST_User()->settings['register_header_title'] ); ?></h3>
    </div>
    <?php } ?>
    ...
    <div class="stuser-form-body">
        ...
        <p class="st-user-msg">
            <?php echo sprintf( __( 'Registration complete ! <a class="stuser-login-link" href="%1$s" title="Login">Click here to login</a> ', 'st-user' ), apply_filters( 'st_login_url', '#' ) ); ?>
        </p>
